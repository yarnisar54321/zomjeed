...
export default function LoginPageClient() {
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
        ...
        <CardContent className="space-y-6 px-8 pb-8">
          <form onSubmit={handleSubmit} className="space-y-6 px-8 pb-8">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-gradient-to-r from-pink-500 to-orange-400 hover:from-pink-600 hover:to-orange-500 text-white font-semibold shadow-lg hover:shadow-[0_0_20px_rgba(236,72,153,0.6)] transition-all duration-300 transform hover:scale-[1.02]"
            >
              Log In
            </Button>
  ...
  onClick={() => {
    ...
    console.log("➡ Redirecting to LINE:", lineLoginUrl)
  ...
  Login with LINE
              ...
              >
                <svg className="w-5 h-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.365 9.863c.349 0 .63.285.63.631 0 .345-.281.63-.63.63H17.61v1.125h1.755c.349 0 .63.283.63.63 0 .344-.281.629-.63.629h-2.386c-.345 0-.627-.285-.627-.629V8.108c0-.345.285-.63.63-.63.348 0 .63.285.63.63v4.141h1.756c.348 0 .629.283.629.63 0 .344-.282.629-.629.629M24 10.314C24 4.943 18.615.572 12 .572S0 4.943 0 10.314c0 4.811 4.27 8.842 10.035 9.608.391-.855.496-1.05.739-3.468.033-.447.161-.888.372-1.277.155-.287.337-.543.535-.775.586-.686 1.337-1.118 2.171-1.118 1.714 0 3.096 1.235 3.096 2.756 0 .45-.313.81-.7.81-.387 0-.7-.36-.7-.81 0-.734-.896-1.33-2.006-1.33-.49 0-.944.15-1.297.404-.353.254-.56.606-.56.996 0 .585.295 1.095.742 1.354.447.26.742.775.742 1.365v.046c-.024 2.066.018 2.465.355 3.18C19.73 19.156 24 15.125 24 10.314" />
                </svg>
